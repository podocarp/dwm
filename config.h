...
/* layout(s) */
static const float mfact     = 0.375; /* factor of master area size [0.05..0.95] */
...
//static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_white, "-sf", col_black, NULL };
